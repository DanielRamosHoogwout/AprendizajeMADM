...
En el siguiente documento se utilizan los datos extraidos de https://www.kaggle.com/uciml/breast-cancer-wisconsin-data para hacer competir modelos de Boosting y Random Forest.

### Carga de datos y limpieza

Se cargan los datos y se eliminan 2 columnas que no nos interesan para clasificar datos y aparte un de ellos contenia NA's
```{r load, eval=FALSE}
set.seed(2021)
#Cargamos los datos
