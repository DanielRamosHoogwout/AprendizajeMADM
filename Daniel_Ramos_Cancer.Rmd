...
En el siguiente documento se utilizan los datos extraidos de https://www.kaggle.com/uciml/breast-cancer-wisconsin-data para hacer competir modelos de Boosting y Random Forest a la hora de clasificar si un cancer es benigno o maligno.

### Carga de datos y limpieza

Se cargan los datos y se eliminan 2 columnas que no nos interesan para clasificar datos y aparte uno de ellos contenia NA's
```{r load, eval=FALSE}
set.seed(2021)
#Cargamos los datos
...
El próposito final de este documento no es clasificar el cancer de la mejor manera posible sino demostrar que se han asimilado los conceptos explicados durante el curso y su aplicación en este trabajo.
